...
function Reviews() {
  ...
  return (
    <Container className="reviews-container py-5">
      <h1 className="text-center mb-5 serif-font">Book Reviews</h1>
          ...
          <Col key={idx}>
            <Card className="review-card">
              <Card.Body>
                ...
                <Card.Title className="review-title serif-font">{review.title}</Card.Title>
                ...
                <Card.Text className="review-content">{review.review}</Card.Text>
                <a href={review.bookLink} className="book-link" target="_blank" rel="noopener noreferrer">
                  Read More →
                </a>
              </Card.Body>
            </Card>
